...
#SBATCH -J gwas
#SBATCH -o e_o_files/both_dom.%j.o
#SBATCH -e e_o_files/both_dom.%j.e
#SBATCH -p skx
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -t 48:00:00
...
$plink2 \
    --glm no-x-sex hide-covar genotypic \
    ...
    --covar ../../GWAS_INPUT/20250921_covar_both.txt \
    --covar-name BIRTH_YEAR SEX $(printf "PC%i " $(seq 1 10)) \
    --covar-variance-standardize \
    --out ../../PLINK_LM_OUTPUT/${out_folder_name}/${date}_both_dom